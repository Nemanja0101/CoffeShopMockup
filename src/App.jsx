...
const featured = [
  {
    ...
    longDescription: "Our signature blend sources beans from small farms in Central America, slow-roasted to bring out their natural sweetness. A perfect shot showcases the espresso's full body with a lingering finish that coats your palate.",
    price: "$4.50",
    emoji: "☕",
    badge: "Bestseller",
    tags: ["Hot", "Vegan"],
  ...
  },
  {
    ...
    longDescription: "Steamed to the perfect temperature, our oat milk creates a naturally sweet base that pairs beautifully with our small-batch caramel reduction. The salted foam adds a gourmet touch that balances richness with a hint of sea salt.",
    price: "$6.25",
    emoji: "🥛",
    badge: null,
    tags: ["Hot", "Dairy-free"],
  ...
  },
  {
    ...
    longDescription: "Our signature cold brew method extracts every nuance of flavor without bitterness, resulting in a silky-smooth cup. The subtle vanilla undertones and bright citrus notes make it equally refreshing on its own or with a splash of oat milk.",
    price: "$5.75",
    emoji: "🧊",
    badge: "Seasonal",
    tags: ["Cold", "Vegan"],
    ...
    <div className="min-h-screen bg-choco-50 text-choco-900 font-sans">
      ...
      <nav className="flex items-center justify-between px-8 py-5 bg-choco-900 text-choco-100">
        <button
          ...
          className="text-2xl font-bold tracking-tight hover:text-choco-300 transition-colors"
        >
          ☕ Brewed Awakening
        </button>
        <div className="flex gap-6 text-sm font-medium">
          {[
            ...
            <button
              ...
              className={`hover:text-choco-300 transition-colors ${page === tab.id ? "text-choco-300" : ""}`}
            >
              {tab.label}
            </button>
          ))}
          ...
          <section className="flex flex-col items-center justify-center text-center px-6 py-28 bg-choco-800 text-choco-50">
            ...
            <div className="flex gap-4 flex-wrap justify-center">
              <button
                ...
                className="bg-choco-500 hover:bg-choco-400 text-choco-50 font-bold px-8 py-3 rounded-full transition-colors"
              >
                View Full Menu
              </button>
